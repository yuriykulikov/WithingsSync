package com.github.yuriykulikov.withingssync.common

import android.app.Application
import android.content.Context
import com.github.yuriykulikov.withingssync.BuildConfig
import com.github.yuriykulikov.withingssync.R
  ...
  fun attachToMainThread(application: Application) {
    application.initAcra {
      ...
      mailSender {
        ...
        enabled = true
        subject = "${context.getString(R.string.app_name)} ${BuildConfig.VERSION_NAME} Bug Report"
